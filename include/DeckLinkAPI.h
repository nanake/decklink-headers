/*** Autogenerated by WIDL 8.14 from DeckLinkAPI.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_QueryInterface(IDeckLinkEncoderConfiguration* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderConfiguration_AddRef(IDeckLinkEncoderConfiguration* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderConfiguration_Release(IDeckLinkEncoderConfiguration* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderConfiguration methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_SetFlag(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,BOOL value) {
    return This->lpVtbl->SetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_GetFlag(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_SetInt(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,LONGLONG value) {
    return This->lpVtbl->SetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_GetInt(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_SetFloat(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,double value) {
    return This->lpVtbl->SetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_GetFloat(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,double *value) {
    return This->lpVtbl->GetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_SetString(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,BSTR value) {
    return This->lpVtbl->SetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_GetString(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,BSTR *value) {
    return This->lpVtbl->GetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_GetBytes(IDeckLinkEncoderConfiguration* This,BMDDeckLinkEncoderConfigurationID cfgID,void *buffer,unsigned int *bufferSize) {
...
static __WIDL_INLINE HRESULT IDeckLinkDeckControlStatusCallback_DeckControlStatusChanged(IDeckLinkDeckControlStatusCallback* This,BMDDeckControlStatusFlags flags,unsigned int mask) {
...
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_SendCommand(IDeckLinkDeckControl* This,unsigned char *inBuffer,unsigned int inBufferSize,unsigned char *outBuffer,unsigned int *outDataSize,unsigned int outBufferSize,BMDDeckControlError *error) {
...
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_SetPreroll(IDeckLinkDeckControl* This,unsigned int prerollSeconds) {
    return This->lpVtbl->SetPreroll(This,prerollSeconds);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_GetPreroll(IDeckLinkDeckControl* This,unsigned int *prerollSeconds) {
    return This->lpVtbl->GetPreroll(This,prerollSeconds);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_SetExportOffset(IDeckLinkDeckControl* This,int exportOffsetFields) {
    return This->lpVtbl->SetExportOffset(This,exportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_GetExportOffset(IDeckLinkDeckControl* This,int *exportOffsetFields) {
    return This->lpVtbl->GetExportOffset(This,exportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_GetManualExportOffset(IDeckLinkDeckControl* This,int *deckManualExportOffsetFields) {
    return This->lpVtbl->GetManualExportOffset(This,deckManualExportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_SetCaptureOffset(IDeckLinkDeckControl* This,int captureOffsetFields) {
    return This->lpVtbl->SetCaptureOffset(This,captureOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_GetCaptureOffset(IDeckLinkDeckControl* This,int *captureOffsetFields) {
...
/*** IBMDStreamingMutableVideoEncodingMode methods ***/
static __WIDL_INLINE HRESULT IBMDStreamingMutableVideoEncodingMode_SetSourceRect(IBMDStreamingMutableVideoEncodingMode* This,unsigned int posX,unsigned int posY,unsigned int width,unsigned int height) {
    return This->lpVtbl->SetSourceRect(This,posX,posY,width,height);
}
static __WIDL_INLINE HRESULT IBMDStreamingMutableVideoEncodingMode_SetDestSize(IBMDStreamingMutableVideoEncodingMode* This,unsigned int width,unsigned int height) {
...
static __WIDL_INLINE HRESULT IBMDStreamingH264NALPacket_GetPacketIndex(IBMDStreamingH264NALPacket* This,unsigned int *packetIndex) {
...
static __WIDL_INLINE HRESULT IBMDStreamingAudioPacket_GetPacketIndex(IBMDStreamingAudioPacket* This,unsigned int *packetIndex) {
    return This->lpVtbl->GetPacketIndex(This,packetIndex);
}
#endif
#endif
...
static __WIDL_INLINE HRESULT IBMDStreamingH264NALParser_GetProfileAndLevelFromSPS(IBMDStreamingH264NALParser* This,IBMDStreamingH264NALPacket *nal,unsigned int *profileIdc,unsigned int *profileCompatability,unsigned int *levelIdc) {
...
typedef enum _BMDEthernetLinkState {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderInputCallback_QueryInterface(IDeckLinkEncoderInputCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderInputCallback_AddRef(IDeckLinkEncoderInputCallback* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderInputCallback_Release(IDeckLinkEncoderInputCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderInputCallback methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderInputCallback_VideoInputSignalChanged(IDeckLinkEncoderInputCallback* This,BMDVideoInputFormatChangedEvents notificationEvents,IDeckLinkDisplayMode *newDisplayMode,BMDDetectedVideoInputFormatFlags detectedSignalFlags) {
    return This->lpVtbl->VideoInputSignalChanged(This,notificationEvents,newDisplayMode,detectedSignalFlags);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInputCallback_VideoPacketArrived(IDeckLinkEncoderInputCallback* This,IDeckLinkEncoderVideoPacket *videoPacket) {
    return This->lpVtbl->VideoPacketArrived(This,videoPacket);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInputCallback_AudioPacketArrived(IDeckLinkEncoderInputCallback* This,IDeckLinkEncoderAudioPacket *audioPacket) {
...
/*** IDeckLinkMemoryAllocator methods ***/
static __WIDL_INLINE HRESULT IDeckLinkMemoryAllocator_AllocateBuffer(IDeckLinkMemoryAllocator* This,unsigned int bufferSize,void **allocatedBuffer) {
...
/*** IDeckLinkOutput methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_DoesSupportVideoMode(IDeckLinkOutput* This,BMDVideoConnection connection,BMDDisplayMode requestedMode,BMDPixelFormat requestedPixelFormat,BMDVideoOutputConversionMode conversionMode,BMDSupportedVideoModeFlags flags,BMDDisplayMode *actualMode,BOOL *supported) {
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_GetDisplayMode(IDeckLinkOutput* This,BMDDisplayMode displayMode,IDeckLinkDisplayMode **resultDisplayMode) {
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_CreateVideoFrame(IDeckLinkOutput* This,int width,int height,int rowBytes,BMDPixelFormat pixelFormat,BMDFrameFlags flags,IDeckLinkMutableVideoFrame **outFrame) {
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_GetBufferedVideoFrameCount(IDeckLinkOutput* This,unsigned int *bufferedFrameCount) {
    return This->lpVtbl->GetBufferedVideoFrameCount(This,bufferedFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_EnableAudioOutput(IDeckLinkOutput* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount,BMDAudioOutputStreamType streamType) {
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_WriteAudioSamplesSync(IDeckLinkOutput* This,void *buffer,unsigned int sampleFrameCount,unsigned int *sampleFramesWritten) {
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_ScheduleAudioSamples(IDeckLinkOutput* This,void *buffer,unsigned int sampleFrameCount,BMDTimeValue streamTime,BMDTimeScale timeScale,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->ScheduleAudioSamples(This,buffer,sampleFrameCount,streamTime,timeScale,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_GetBufferedAudioSampleFrameCount(IDeckLinkOutput* This,unsigned int *bufferedSampleFrameCount) {
...
/*** IDeckLinkInput methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_DoesSupportVideoMode(IDeckLinkInput* This,BMDVideoConnection connection,BMDDisplayMode requestedMode,BMDPixelFormat requestedPixelFormat,BMDVideoInputConversionMode conversionMode,BMDSupportedVideoModeFlags flags,BMDDisplayMode *actualMode,BOOL *supported) {
    return This->lpVtbl->DoesSupportVideoMode(This,connection,requestedMode,requestedPixelFormat,conversionMode,flags,actualMode,supported);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_GetDisplayMode(IDeckLinkInput* This,BMDDisplayMode displayMode,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->GetDisplayMode(This,displayMode,resultDisplayMode);
}
...
static __WIDL_INLINE HRESULT IDeckLinkInput_GetAvailableVideoFrameCount(IDeckLinkInput* This,unsigned int *availableFrameCount) {
...
static __WIDL_INLINE HRESULT IDeckLinkInput_EnableAudioInput(IDeckLinkInput* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
...
static __WIDL_INLINE HRESULT IDeckLinkInput_GetAvailableAudioSampleFrameCount(IDeckLinkInput* This,unsigned int *availableSampleFrameCount) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkHDMIInputEDID_QueryInterface(IDeckLinkHDMIInputEDID* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkHDMIInputEDID_AddRef(IDeckLinkHDMIInputEDID* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkHDMIInputEDID_Release(IDeckLinkHDMIInputEDID* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkHDMIInputEDID methods ***/
static __WIDL_INLINE HRESULT IDeckLinkHDMIInputEDID_SetInt(IDeckLinkHDMIInputEDID* This,BMDDeckLinkHDMIInputEDIDID cfgID,LONGLONG value) {
    return This->lpVtbl->SetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkHDMIInputEDID_GetInt(IDeckLinkHDMIInputEDID* This,BMDDeckLinkHDMIInputEDIDID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkHDMIInputEDID_WriteToEDID(IDeckLinkHDMIInputEDID* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_QueryInterface(IDeckLinkEncoderInput* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderInput_AddRef(IDeckLinkEncoderInput* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderInput_Release(IDeckLinkEncoderInput* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderInput methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_DoesSupportVideoMode(IDeckLinkEncoderInput* This,BMDVideoConnection connection,BMDDisplayMode requestedMode,BMDPixelFormat requestedCodec,unsigned int requestedCodecProfile,BMDSupportedVideoModeFlags flags,BOOL *supported) {
...
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_GetDisplayMode(IDeckLinkEncoderInput* This,BMDDisplayMode displayMode,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->GetDisplayMode(This,displayMode,resultDisplayMode);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_GetDisplayModeIterator(IDeckLinkEncoderInput* This,IDeckLinkDisplayModeIterator **iterator) {
    return This->lpVtbl->GetDisplayModeIterator(This,iterator);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_EnableVideoInput(IDeckLinkEncoderInput* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoInputFlags flags) {
    return This->lpVtbl->EnableVideoInput(This,displayMode,pixelFormat,flags);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_DisableVideoInput(IDeckLinkEncoderInput* This) {
    return This->lpVtbl->DisableVideoInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_GetAvailablePacketsCount(IDeckLinkEncoderInput* This,unsigned int *availablePacketsCount) {
    return This->lpVtbl->GetAvailablePacketsCount(This,availablePacketsCount);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_SetMemoryAllocator(IDeckLinkEncoderInput* This,IDeckLinkMemoryAllocator *theAllocator) {
    return This->lpVtbl->SetMemoryAllocator(This,theAllocator);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_EnableAudioInput(IDeckLinkEncoderInput* This,BMDAudioFormat audioFormat,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,audioFormat,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_DisableAudioInput(IDeckLinkEncoderInput* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_GetAvailableAudioSampleFrameCount(IDeckLinkEncoderInput* This,unsigned int *availableSampleFrameCount) {
    return This->lpVtbl->GetAvailableAudioSampleFrameCount(This,availableSampleFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_StartStreams(IDeckLinkEncoderInput* This) {
    return This->lpVtbl->StartStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_StopStreams(IDeckLinkEncoderInput* This) {
    return This->lpVtbl->StopStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_PauseStreams(IDeckLinkEncoderInput* This) {
    return This->lpVtbl->PauseStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_FlushStreams(IDeckLinkEncoderInput* This) {
    return This->lpVtbl->FlushStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_SetCallback(IDeckLinkEncoderInput* This,IDeckLinkEncoderInputCallback *theCallback) {
    return This->lpVtbl->SetCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_GetHardwareReferenceClock(IDeckLinkEncoderInput* This,BMDTimeScale desiredTimeScale,BMDTimeValue *hardwareTime,BMDTimeValue *timeInFrame,BMDTimeValue *ticksPerFrame) {
    return This->lpVtbl->GetHardwareReferenceClock(This,desiredTimeScale,hardwareTime,timeInFrame,ticksPerFrame);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_QueryInterface(IDeckLinkVideoFrameMetadataExtensions* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkVideoFrameMetadataExtensions_AddRef(IDeckLinkVideoFrameMetadataExtensions* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkVideoFrameMetadataExtensions_Release(IDeckLinkVideoFrameMetadataExtensions* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkVideoFrameMetadataExtensions methods ***/
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_GetInt(IDeckLinkVideoFrameMetadataExtensions* This,BMDDeckLinkFrameMetadataID metadataID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,metadataID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_GetFloat(IDeckLinkVideoFrameMetadataExtensions* This,BMDDeckLinkFrameMetadataID metadataID,double *value) {
    return This->lpVtbl->GetFloat(This,metadataID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_GetFlag(IDeckLinkVideoFrameMetadataExtensions* This,BMDDeckLinkFrameMetadataID metadataID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,metadataID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_GetString(IDeckLinkVideoFrameMetadataExtensions* This,BMDDeckLinkFrameMetadataID metadataID,BSTR *value) {
    return This->lpVtbl->GetString(This,metadataID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_GetBytes(IDeckLinkVideoFrameMetadataExtensions* This,BMDDeckLinkFrameMetadataID metadataID,void *buffer,unsigned int *bufferSize) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkAncillaryPacket_QueryInterface(IDeckLinkAncillaryPacket* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkAncillaryPacket_AddRef(IDeckLinkAncillaryPacket* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkAncillaryPacket_Release(IDeckLinkAncillaryPacket* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkAncillaryPacket methods ***/
static __WIDL_INLINE HRESULT IDeckLinkAncillaryPacket_GetBytes(IDeckLinkAncillaryPacket* This,BMDAncillaryPacketFormat format,const void **data,unsigned int *size) {
    return This->lpVtbl->GetBytes(This,format,data,size);
}
static __WIDL_INLINE unsigned char IDeckLinkAncillaryPacket_GetDID(IDeckLinkAncillaryPacket* This) {
    return This->lpVtbl->GetDID(This);
}
static __WIDL_INLINE unsigned char IDeckLinkAncillaryPacket_GetSDID(IDeckLinkAncillaryPacket* This) {
    return This->lpVtbl->GetSDID(This);
}
static __WIDL_INLINE unsigned int IDeckLinkAncillaryPacket_GetLineNumber(IDeckLinkAncillaryPacket* This) {
    return This->lpVtbl->GetLineNumber(This);
}
static __WIDL_INLINE unsigned char IDeckLinkAncillaryPacket_GetDataStreamIndex(IDeckLinkAncillaryPacket* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkAncillaryPacketIterator_QueryInterface(IDeckLinkAncillaryPacketIterator* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkAncillaryPacketIterator_AddRef(IDeckLinkAncillaryPacketIterator* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkAncillaryPacketIterator_Release(IDeckLinkAncillaryPacketIterator* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkAncillaryPacketIterator methods ***/
static __WIDL_INLINE HRESULT IDeckLinkAncillaryPacketIterator_Next(IDeckLinkAncillaryPacketIterator* This,IDeckLinkAncillaryPacket **packet) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameAncillaryPackets_QueryInterface(IDeckLinkVideoFrameAncillaryPackets* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkVideoFrameAncillaryPackets_AddRef(IDeckLinkVideoFrameAncillaryPackets* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkVideoFrameAncillaryPackets_Release(IDeckLinkVideoFrameAncillaryPackets* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkVideoFrameAncillaryPackets methods ***/
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameAncillaryPackets_GetPacketIterator(IDeckLinkVideoFrameAncillaryPackets* This,IDeckLinkAncillaryPacketIterator **iterator) {
    return This->lpVtbl->GetPacketIterator(This,iterator);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameAncillaryPackets_GetFirstPacketByID(IDeckLinkVideoFrameAncillaryPackets* This,unsigned char DID,unsigned char SDID,IDeckLinkAncillaryPacket **packet) {
    return This->lpVtbl->GetFirstPacketByID(This,DID,SDID,packet);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameAncillaryPackets_AttachPacket(IDeckLinkVideoFrameAncillaryPackets* This,IDeckLinkAncillaryPacket *packet) {
    return This->lpVtbl->AttachPacket(This,packet);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameAncillaryPackets_DetachPacket(IDeckLinkVideoFrameAncillaryPackets* This,IDeckLinkAncillaryPacket *packet) {
    return This->lpVtbl->DetachPacket(This,packet);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameAncillaryPackets_DetachAllPackets(IDeckLinkVideoFrameAncillaryPackets* This) {
...
/*** IDeckLinkVideoFrameAncillary methods ***/
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameAncillary_GetBufferForVerticalBlankingLine(IDeckLinkVideoFrameAncillary* This,unsigned int lineNumber,void **buffer) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderPacket_QueryInterface(IDeckLinkEncoderPacket* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderPacket_AddRef(IDeckLinkEncoderPacket* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderPacket_Release(IDeckLinkEncoderPacket* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderPacket methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderPacket_GetBytes(IDeckLinkEncoderPacket* This,void **buffer) {
    return This->lpVtbl->GetBytes(This,buffer);
}
static __WIDL_INLINE LONG IDeckLinkEncoderPacket_GetSize(IDeckLinkEncoderPacket* This) {
    return This->lpVtbl->GetSize(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderPacket_GetStreamTime(IDeckLinkEncoderPacket* This,BMDTimeValue *frameTime,BMDTimeScale timeScale) {
    return This->lpVtbl->GetStreamTime(This,frameTime,timeScale);
}
static __WIDL_INLINE BMDPacketType IDeckLinkEncoderPacket_GetPacketType(IDeckLinkEncoderPacket* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderVideoPacket_QueryInterface(IDeckLinkEncoderVideoPacket* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderVideoPacket_AddRef(IDeckLinkEncoderVideoPacket* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderVideoPacket_Release(IDeckLinkEncoderVideoPacket* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderPacket methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderVideoPacket_GetBytes(IDeckLinkEncoderVideoPacket* This,void **buffer) {
    return This->lpVtbl->GetBytes(This,buffer);
}
static __WIDL_INLINE LONG IDeckLinkEncoderVideoPacket_GetSize(IDeckLinkEncoderVideoPacket* This) {
    return This->lpVtbl->GetSize(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderVideoPacket_GetStreamTime(IDeckLinkEncoderVideoPacket* This,BMDTimeValue *frameTime,BMDTimeScale timeScale) {
    return This->lpVtbl->GetStreamTime(This,frameTime,timeScale);
}
static __WIDL_INLINE BMDPacketType IDeckLinkEncoderVideoPacket_GetPacketType(IDeckLinkEncoderVideoPacket* This) {
    return This->lpVtbl->GetPacketType(This);
}
/*** IDeckLinkEncoderVideoPacket methods ***/
static __WIDL_INLINE BMDPixelFormat IDeckLinkEncoderVideoPacket_GetPixelFormat(IDeckLinkEncoderVideoPacket* This) {
    return This->lpVtbl->GetPixelFormat(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderVideoPacket_GetHardwareReferenceTimestamp(IDeckLinkEncoderVideoPacket* This,BMDTimeScale timeScale,BMDTimeValue *frameTime,BMDTimeValue *frameDuration) {
    return This->lpVtbl->GetHardwareReferenceTimestamp(This,timeScale,frameTime,frameDuration);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderVideoPacket_GetTimecode(IDeckLinkEncoderVideoPacket* This,BMDTimecodeFormat format,IDeckLinkTimecode **timecode) {
    return This->lpVtbl->GetTimecode(This,format,timecode);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderAudioPacket_QueryInterface(IDeckLinkEncoderAudioPacket* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderAudioPacket_AddRef(IDeckLinkEncoderAudioPacket* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderAudioPacket_Release(IDeckLinkEncoderAudioPacket* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderPacket methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderAudioPacket_GetBytes(IDeckLinkEncoderAudioPacket* This,void **buffer) {
    return This->lpVtbl->GetBytes(This,buffer);
}
static __WIDL_INLINE LONG IDeckLinkEncoderAudioPacket_GetSize(IDeckLinkEncoderAudioPacket* This) {
    return This->lpVtbl->GetSize(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderAudioPacket_GetStreamTime(IDeckLinkEncoderAudioPacket* This,BMDTimeValue *frameTime,BMDTimeScale timeScale) {
    return This->lpVtbl->GetStreamTime(This,frameTime,timeScale);
}
static __WIDL_INLINE BMDPacketType IDeckLinkEncoderAudioPacket_GetPacketType(IDeckLinkEncoderAudioPacket* This) {
    return This->lpVtbl->GetPacketType(This);
}
/*** IDeckLinkEncoderAudioPacket methods ***/
static __WIDL_INLINE BMDAudioFormat IDeckLinkEncoderAudioPacket_GetAudioFormat(IDeckLinkEncoderAudioPacket* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkH265NALPacket_QueryInterface(IDeckLinkH265NALPacket* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkH265NALPacket_AddRef(IDeckLinkH265NALPacket* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkH265NALPacket_Release(IDeckLinkH265NALPacket* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderPacket methods ***/
static __WIDL_INLINE HRESULT IDeckLinkH265NALPacket_GetBytes(IDeckLinkH265NALPacket* This,void **buffer) {
    return This->lpVtbl->GetBytes(This,buffer);
}
static __WIDL_INLINE LONG IDeckLinkH265NALPacket_GetSize(IDeckLinkH265NALPacket* This) {
    return This->lpVtbl->GetSize(This);
}
static __WIDL_INLINE HRESULT IDeckLinkH265NALPacket_GetStreamTime(IDeckLinkH265NALPacket* This,BMDTimeValue *frameTime,BMDTimeScale timeScale) {
    return This->lpVtbl->GetStreamTime(This,frameTime,timeScale);
}
static __WIDL_INLINE BMDPacketType IDeckLinkH265NALPacket_GetPacketType(IDeckLinkH265NALPacket* This) {
    return This->lpVtbl->GetPacketType(This);
}
/*** IDeckLinkEncoderVideoPacket methods ***/
static __WIDL_INLINE BMDPixelFormat IDeckLinkH265NALPacket_GetPixelFormat(IDeckLinkH265NALPacket* This) {
    return This->lpVtbl->GetPixelFormat(This);
}
static __WIDL_INLINE HRESULT IDeckLinkH265NALPacket_GetHardwareReferenceTimestamp(IDeckLinkH265NALPacket* This,BMDTimeScale timeScale,BMDTimeValue *frameTime,BMDTimeValue *frameDuration) {
    return This->lpVtbl->GetHardwareReferenceTimestamp(This,timeScale,frameTime,frameDuration);
}
static __WIDL_INLINE HRESULT IDeckLinkH265NALPacket_GetTimecode(IDeckLinkH265NALPacket* This,BMDTimecodeFormat format,IDeckLinkTimecode **timecode) {
    return This->lpVtbl->GetTimecode(This,format,timecode);
}
/*** IDeckLinkH265NALPacket methods ***/
static __WIDL_INLINE HRESULT IDeckLinkH265NALPacket_GetUnitType(IDeckLinkH265NALPacket* This,unsigned char *unitType) {
    return This->lpVtbl->GetUnitType(This,unitType);
}
static __WIDL_INLINE HRESULT IDeckLinkH265NALPacket_GetBytesNoPrefix(IDeckLinkH265NALPacket* This,void **buffer) {
    return This->lpVtbl->GetBytesNoPrefix(This,buffer);
}
static __WIDL_INLINE LONG IDeckLinkH265NALPacket_GetSizeNoPrefix(IDeckLinkH265NALPacket* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkWPFDX9ScreenPreviewHelper_QueryInterface(IDeckLinkWPFDX9ScreenPreviewHelper* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkWPFDX9ScreenPreviewHelper_AddRef(IDeckLinkWPFDX9ScreenPreviewHelper* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkWPFDX9ScreenPreviewHelper_Release(IDeckLinkWPFDX9ScreenPreviewHelper* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkWPFDX9ScreenPreviewHelper methods ***/
static __WIDL_INLINE HRESULT IDeckLinkWPFDX9ScreenPreviewHelper_Initialize(IDeckLinkWPFDX9ScreenPreviewHelper* This) {
    return This->lpVtbl->Initialize(This);
}
static __WIDL_INLINE HRESULT IDeckLinkWPFDX9ScreenPreviewHelper_Render(IDeckLinkWPFDX9ScreenPreviewHelper* This) {
    return This->lpVtbl->Render(This);
}
static __WIDL_INLINE HRESULT IDeckLinkWPFDX9ScreenPreviewHelper_SetSurfaceSize(IDeckLinkWPFDX9ScreenPreviewHelper* This,unsigned int width,unsigned int height) {
    return This->lpVtbl->SetSurfaceSize(This,width,height);
}
static __WIDL_INLINE HRESULT IDeckLinkWPFDX9ScreenPreviewHelper_SetFrame(IDeckLinkWPFDX9ScreenPreviewHelper* This,IDeckLinkVideoFrame *theFrame) {
    return This->lpVtbl->SetFrame(This,theFrame);
}
static __WIDL_INLINE HRESULT IDeckLinkWPFDX9ScreenPreviewHelper_Set3DPreviewFormat(IDeckLinkWPFDX9ScreenPreviewHelper* This,BMD3DPreviewFormat previewFormat) {
    return This->lpVtbl->Set3DPreviewFormat(This,previewFormat);
}
static __WIDL_INLINE HRESULT IDeckLinkWPFDX9ScreenPreviewHelper_GetBackBuffer(IDeckLinkWPFDX9ScreenPreviewHelper* This,void **backBuffer) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfileAttributes_QueryInterface(IDeckLinkProfileAttributes* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkProfileAttributes_AddRef(IDeckLinkProfileAttributes* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkProfileAttributes_Release(IDeckLinkProfileAttributes* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkProfileAttributes methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfileAttributes_GetFlag(IDeckLinkProfileAttributes* This,BMDDeckLinkAttributeID cfgID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkProfileAttributes_GetInt(IDeckLinkProfileAttributes* This,BMDDeckLinkAttributeID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkProfileAttributes_GetFloat(IDeckLinkProfileAttributes* This,BMDDeckLinkAttributeID cfgID,double *value) {
    return This->lpVtbl->GetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkProfileAttributes_GetString(IDeckLinkProfileAttributes* This,BMDDeckLinkAttributeID cfgID,BSTR *value) {
    return This->lpVtbl->GetString(This,cfgID,value);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfileIterator_QueryInterface(IDeckLinkProfileIterator* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkProfileIterator_AddRef(IDeckLinkProfileIterator* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkProfileIterator_Release(IDeckLinkProfileIterator* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkProfileIterator methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfileIterator_Next(IDeckLinkProfileIterator* This,IDeckLinkProfile **profile) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfile_QueryInterface(IDeckLinkProfile* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkProfile_AddRef(IDeckLinkProfile* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkProfile_Release(IDeckLinkProfile* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkProfile methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfile_GetDevice(IDeckLinkProfile* This,IDeckLink **device) {
    return This->lpVtbl->GetDevice(This,device);
}
static __WIDL_INLINE HRESULT IDeckLinkProfile_IsActive(IDeckLinkProfile* This,BOOL *isActive) {
    return This->lpVtbl->IsActive(This,isActive);
}
static __WIDL_INLINE HRESULT IDeckLinkProfile_SetActive(IDeckLinkProfile* This) {
    return This->lpVtbl->SetActive(This);
}
static __WIDL_INLINE HRESULT IDeckLinkProfile_GetPeers(IDeckLinkProfile* This,IDeckLinkProfileIterator **profileIterator) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfileCallback_QueryInterface(IDeckLinkProfileCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkProfileCallback_AddRef(IDeckLinkProfileCallback* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkProfileCallback_Release(IDeckLinkProfileCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkProfileCallback methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfileCallback_ProfileChanging(IDeckLinkProfileCallback* This,IDeckLinkProfile *profileToBeActivated,BOOL streamsWillBeForcedToStop) {
    return This->lpVtbl->ProfileChanging(This,profileToBeActivated,streamsWillBeForcedToStop);
}
static __WIDL_INLINE HRESULT IDeckLinkProfileCallback_ProfileActivated(IDeckLinkProfileCallback* This,IDeckLinkProfile *activatedProfile) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfileManager_QueryInterface(IDeckLinkProfileManager* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkProfileManager_AddRef(IDeckLinkProfileManager* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkProfileManager_Release(IDeckLinkProfileManager* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkProfileManager methods ***/
static __WIDL_INLINE HRESULT IDeckLinkProfileManager_GetProfiles(IDeckLinkProfileManager* This,IDeckLinkProfileIterator **profileIterator) {
    return This->lpVtbl->GetProfiles(This,profileIterator);
}
static __WIDL_INLINE HRESULT IDeckLinkProfileManager_GetProfile(IDeckLinkProfileManager* This,BMDProfileID profileID,IDeckLinkProfile **profile) {
    return This->lpVtbl->GetProfile(This,profileID,profile);
}
static __WIDL_INLINE HRESULT IDeckLinkProfileManager_SetCallback(IDeckLinkProfileManager* This,IDeckLinkProfileCallback *callback) {
    return This->lpVtbl->SetCallback(This,callback);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkStatus_QueryInterface(IDeckLinkStatus* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkStatus_AddRef(IDeckLinkStatus* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkStatus_Release(IDeckLinkStatus* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkStatus methods ***/
static __WIDL_INLINE HRESULT IDeckLinkStatus_GetFlag(IDeckLinkStatus* This,BMDDeckLinkStatusID statusID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,statusID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkStatus_GetInt(IDeckLinkStatus* This,BMDDeckLinkStatusID statusID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,statusID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkStatus_GetFloat(IDeckLinkStatus* This,BMDDeckLinkStatusID statusID,double *value) {
    return This->lpVtbl->GetFloat(This,statusID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkStatus_GetString(IDeckLinkStatus* This,BMDDeckLinkStatusID statusID,BSTR *value) {
    return This->lpVtbl->GetString(This,statusID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkStatus_GetBytes(IDeckLinkStatus* This,BMDDeckLinkStatusID statusID,void *buffer,unsigned int *bufferSize) {
...
static __WIDL_INLINE HRESULT IDeckLinkKeyer_RampUp(IDeckLinkKeyer* This,unsigned int numberOfFrames) {
    return This->lpVtbl->RampUp(This,numberOfFrames);
}
static __WIDL_INLINE HRESULT IDeckLinkKeyer_RampDown(IDeckLinkKeyer* This,unsigned int numberOfFrames) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInputCallback_v11_5_1_QueryInterface(IDeckLinkInputCallback_v11_5_1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkInputCallback_v11_5_1_AddRef(IDeckLinkInputCallback_v11_5_1* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkInputCallback_v11_5_1_Release(IDeckLinkInputCallback_v11_5_1* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkInputCallback_v11_5_1 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInputCallback_v11_5_1_VideoInputFormatChanged(IDeckLinkInputCallback_v11_5_1* This,BMDVideoInputFormatChangedEvents notificationEvents,IDeckLinkDisplayMode *newDisplayMode,BMDDetectedVideoInputFormatFlags detectedSignalFlags) {
    return This->lpVtbl->VideoInputFormatChanged(This,notificationEvents,newDisplayMode,detectedSignalFlags);
}
static __WIDL_INLINE HRESULT IDeckLinkInputCallback_v11_5_1_VideoInputFrameArrived(IDeckLinkInputCallback_v11_5_1* This,IDeckLinkVideoInputFrame *videoFrame,IDeckLinkAudioInputPacket *audioPacket) {
    return This->lpVtbl->VideoInputFrameArrived(This,videoFrame,audioPacket);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_QueryInterface(IDeckLinkInput_v11_5_1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkInput_v11_5_1_AddRef(IDeckLinkInput_v11_5_1* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkInput_v11_5_1_Release(IDeckLinkInput_v11_5_1* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkInput_v11_5_1 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_DoesSupportVideoMode(IDeckLinkInput_v11_5_1* This,BMDVideoConnection connection,BMDDisplayMode requestedMode,BMDPixelFormat requestedPixelFormat,BMDVideoInputConversionMode conversionMode,BMDSupportedVideoModeFlags flags,BMDDisplayMode *actualMode,BOOL *supported) {
    return This->lpVtbl->DoesSupportVideoMode(This,connection,requestedMode,requestedPixelFormat,conversionMode,flags,actualMode,supported);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_GetDisplayMode(IDeckLinkInput_v11_5_1* This,BMDDisplayMode displayMode,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->GetDisplayMode(This,displayMode,resultDisplayMode);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_GetDisplayModeIterator(IDeckLinkInput_v11_5_1* This,IDeckLinkDisplayModeIterator **iterator) {
    return This->lpVtbl->GetDisplayModeIterator(This,iterator);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_SetScreenPreviewCallback(IDeckLinkInput_v11_5_1* This,IDeckLinkScreenPreviewCallback *previewCallback) {
    return This->lpVtbl->SetScreenPreviewCallback(This,previewCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_EnableVideoInput(IDeckLinkInput_v11_5_1* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoInputFlags flags) {
    return This->lpVtbl->EnableVideoInput(This,displayMode,pixelFormat,flags);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_DisableVideoInput(IDeckLinkInput_v11_5_1* This) {
    return This->lpVtbl->DisableVideoInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_GetAvailableVideoFrameCount(IDeckLinkInput_v11_5_1* This,unsigned int *availableFrameCount) {
    return This->lpVtbl->GetAvailableVideoFrameCount(This,availableFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_SetVideoInputFrameMemoryAllocator(IDeckLinkInput_v11_5_1* This,IDeckLinkMemoryAllocator *theAllocator) {
    return This->lpVtbl->SetVideoInputFrameMemoryAllocator(This,theAllocator);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_EnableAudioInput(IDeckLinkInput_v11_5_1* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_DisableAudioInput(IDeckLinkInput_v11_5_1* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_GetAvailableAudioSampleFrameCount(IDeckLinkInput_v11_5_1* This,unsigned int *availableSampleFrameCount) {
    return This->lpVtbl->GetAvailableAudioSampleFrameCount(This,availableSampleFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_StartStreams(IDeckLinkInput_v11_5_1* This) {
    return This->lpVtbl->StartStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_StopStreams(IDeckLinkInput_v11_5_1* This) {
    return This->lpVtbl->StopStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_PauseStreams(IDeckLinkInput_v11_5_1* This) {
    return This->lpVtbl->PauseStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_FlushStreams(IDeckLinkInput_v11_5_1* This) {
    return This->lpVtbl->FlushStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_SetCallback(IDeckLinkInput_v11_5_1* This,IDeckLinkInputCallback_v11_5_1 *theCallback) {
    return This->lpVtbl->SetCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_5_1_GetHardwareReferenceClock(IDeckLinkInput_v11_5_1* This,BMDTimeScale desiredTimeScale,BMDTimeValue *hardwareTime,BMDTimeValue *timeInFrame,BMDTimeValue *ticksPerFrame) {
    return This->lpVtbl->GetHardwareReferenceClock(This,desiredTimeScale,hardwareTime,timeInFrame,ticksPerFrame);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_QueryInterface(IDeckLinkConfiguration_v10_11* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkConfiguration_v10_11_AddRef(IDeckLinkConfiguration_v10_11* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkConfiguration_v10_11_Release(IDeckLinkConfiguration_v10_11* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkConfiguration_v10_11 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_SetFlag(IDeckLinkConfiguration_v10_11* This,BMDDeckLinkConfigurationID cfgID,BOOL value) {
    return This->lpVtbl->SetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_GetFlag(IDeckLinkConfiguration_v10_11* This,BMDDeckLinkConfigurationID cfgID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_SetInt(IDeckLinkConfiguration_v10_11* This,BMDDeckLinkConfigurationID cfgID,LONGLONG value) {
    return This->lpVtbl->SetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_GetInt(IDeckLinkConfiguration_v10_11* This,BMDDeckLinkConfigurationID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_SetFloat(IDeckLinkConfiguration_v10_11* This,BMDDeckLinkConfigurationID cfgID,double value) {
    return This->lpVtbl->SetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_GetFloat(IDeckLinkConfiguration_v10_11* This,BMDDeckLinkConfigurationID cfgID,double *value) {
    return This->lpVtbl->GetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_SetString(IDeckLinkConfiguration_v10_11* This,BMDDeckLinkConfigurationID cfgID,BSTR value) {
    return This->lpVtbl->SetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_GetString(IDeckLinkConfiguration_v10_11* This,BMDDeckLinkConfigurationID cfgID,BSTR *value) {
    return This->lpVtbl->GetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_11_WriteConfigurationToPreferences(IDeckLinkConfiguration_v10_11* This) {
    return This->lpVtbl->WriteConfigurationToPreferences(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkAttributes_v10_11_QueryInterface(IDeckLinkAttributes_v10_11* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkAttributes_v10_11_AddRef(IDeckLinkAttributes_v10_11* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkAttributes_v10_11_Release(IDeckLinkAttributes_v10_11* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkAttributes_v10_11 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkAttributes_v10_11_GetFlag(IDeckLinkAttributes_v10_11* This,BMDDeckLinkAttributeID cfgID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkAttributes_v10_11_GetInt(IDeckLinkAttributes_v10_11* This,BMDDeckLinkAttributeID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkAttributes_v10_11_GetFloat(IDeckLinkAttributes_v10_11* This,BMDDeckLinkAttributeID cfgID,double *value) {
    return This->lpVtbl->GetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkAttributes_v10_11_GetString(IDeckLinkAttributes_v10_11* This,BMDDeckLinkAttributeID cfgID,BSTR *value) {
    return This->lpVtbl->GetString(This,cfgID,value);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_QueryInterface(IDeckLinkOutput_v10_11* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkOutput_v10_11_AddRef(IDeckLinkOutput_v10_11* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkOutput_v10_11_Release(IDeckLinkOutput_v10_11* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkOutput_v10_11 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_DoesSupportVideoMode(IDeckLinkOutput_v10_11* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoOutputFlags flags,BMDDisplayModeSupport_v10_11 *result,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,flags,result,resultDisplayMode);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_GetDisplayModeIterator(IDeckLinkOutput_v10_11* This,IDeckLinkDisplayModeIterator **iterator) {
    return This->lpVtbl->GetDisplayModeIterator(This,iterator);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_SetScreenPreviewCallback(IDeckLinkOutput_v10_11* This,IDeckLinkScreenPreviewCallback *previewCallback) {
    return This->lpVtbl->SetScreenPreviewCallback(This,previewCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_EnableVideoOutput(IDeckLinkOutput_v10_11* This,BMDDisplayMode displayMode,BMDVideoOutputFlags flags) {
    return This->lpVtbl->EnableVideoOutput(This,displayMode,flags);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_DisableVideoOutput(IDeckLinkOutput_v10_11* This) {
    return This->lpVtbl->DisableVideoOutput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_SetVideoOutputFrameMemoryAllocator(IDeckLinkOutput_v10_11* This,IDeckLinkMemoryAllocator *theAllocator) {
    return This->lpVtbl->SetVideoOutputFrameMemoryAllocator(This,theAllocator);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_CreateVideoFrame(IDeckLinkOutput_v10_11* This,int width,int height,int rowBytes,BMDPixelFormat pixelFormat,BMDFrameFlags flags,IDeckLinkMutableVideoFrame **outFrame) {
    return This->lpVtbl->CreateVideoFrame(This,width,height,rowBytes,pixelFormat,flags,outFrame);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_CreateAncillaryData(IDeckLinkOutput_v10_11* This,BMDPixelFormat pixelFormat,IDeckLinkVideoFrameAncillary **outBuffer) {
    return This->lpVtbl->CreateAncillaryData(This,pixelFormat,outBuffer);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_DisplayVideoFrameSync(IDeckLinkOutput_v10_11* This,IDeckLinkVideoFrame *theFrame) {
    return This->lpVtbl->DisplayVideoFrameSync(This,theFrame);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_ScheduleVideoFrame(IDeckLinkOutput_v10_11* This,IDeckLinkVideoFrame *theFrame,BMDTimeValue displayTime,BMDTimeValue displayDuration,BMDTimeScale timeScale) {
    return This->lpVtbl->ScheduleVideoFrame(This,theFrame,displayTime,displayDuration,timeScale);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_SetScheduledFrameCompletionCallback(IDeckLinkOutput_v10_11* This,IDeckLinkVideoOutputCallback *theCallback) {
    return This->lpVtbl->SetScheduledFrameCompletionCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_GetBufferedVideoFrameCount(IDeckLinkOutput_v10_11* This,unsigned int *bufferedFrameCount) {
    return This->lpVtbl->GetBufferedVideoFrameCount(This,bufferedFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_EnableAudioOutput(IDeckLinkOutput_v10_11* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount,BMDAudioOutputStreamType streamType) {
    return This->lpVtbl->EnableAudioOutput(This,sampleRate,sampleType,channelCount,streamType);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_DisableAudioOutput(IDeckLinkOutput_v10_11* This) {
    return This->lpVtbl->DisableAudioOutput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_WriteAudioSamplesSync(IDeckLinkOutput_v10_11* This,void *buffer,unsigned int sampleFrameCount,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->WriteAudioSamplesSync(This,buffer,sampleFrameCount,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_BeginAudioPreroll(IDeckLinkOutput_v10_11* This) {
    return This->lpVtbl->BeginAudioPreroll(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_EndAudioPreroll(IDeckLinkOutput_v10_11* This) {
    return This->lpVtbl->EndAudioPreroll(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_ScheduleAudioSamples(IDeckLinkOutput_v10_11* This,void *buffer,unsigned int sampleFrameCount,BMDTimeValue streamTime,BMDTimeScale timeScale,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->ScheduleAudioSamples(This,buffer,sampleFrameCount,streamTime,timeScale,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_GetBufferedAudioSampleFrameCount(IDeckLinkOutput_v10_11* This,unsigned int *bufferedSampleFrameCount) {
    return This->lpVtbl->GetBufferedAudioSampleFrameCount(This,bufferedSampleFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_FlushBufferedAudioSamples(IDeckLinkOutput_v10_11* This) {
    return This->lpVtbl->FlushBufferedAudioSamples(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_SetAudioCallback(IDeckLinkOutput_v10_11* This,IDeckLinkAudioOutputCallback *theCallback) {
    return This->lpVtbl->SetAudioCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_StartScheduledPlayback(IDeckLinkOutput_v10_11* This,BMDTimeValue playbackStartTime,BMDTimeScale timeScale,double playbackSpeed) {
    return This->lpVtbl->StartScheduledPlayback(This,playbackStartTime,timeScale,playbackSpeed);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_StopScheduledPlayback(IDeckLinkOutput_v10_11* This,BMDTimeValue stopPlaybackAtTime,BMDTimeValue *actualStopTime,BMDTimeScale timeScale) {
    return This->lpVtbl->StopScheduledPlayback(This,stopPlaybackAtTime,actualStopTime,timeScale);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_IsScheduledPlaybackRunning(IDeckLinkOutput_v10_11* This,BOOL *active) {
    return This->lpVtbl->IsScheduledPlaybackRunning(This,active);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_GetScheduledStreamTime(IDeckLinkOutput_v10_11* This,BMDTimeScale desiredTimeScale,BMDTimeValue *streamTime,double *playbackSpeed) {
    return This->lpVtbl->GetScheduledStreamTime(This,desiredTimeScale,streamTime,playbackSpeed);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_GetReferenceStatus(IDeckLinkOutput_v10_11* This,BMDReferenceStatus *referenceStatus) {
    return This->lpVtbl->GetReferenceStatus(This,referenceStatus);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_GetHardwareReferenceClock(IDeckLinkOutput_v10_11* This,BMDTimeScale desiredTimeScale,BMDTimeValue *hardwareTime,BMDTimeValue *timeInFrame,BMDTimeValue *ticksPerFrame) {
    return This->lpVtbl->GetHardwareReferenceClock(This,desiredTimeScale,hardwareTime,timeInFrame,ticksPerFrame);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v10_11_GetFrameCompletionReferenceTimestamp(IDeckLinkOutput_v10_11* This,IDeckLinkVideoFrame *theFrame,BMDTimeScale desiredTimeScale,BMDTimeValue *frameCompletionTimestamp) {
    return This->lpVtbl->GetFrameCompletionReferenceTimestamp(This,theFrame,desiredTimeScale,frameCompletionTimestamp);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_QueryInterface(IDeckLinkInput_v10_11* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkInput_v10_11_AddRef(IDeckLinkInput_v10_11* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkInput_v10_11_Release(IDeckLinkInput_v10_11* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkInput_v10_11 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_DoesSupportVideoMode(IDeckLinkInput_v10_11* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoInputFlags flags,BMDDisplayModeSupport_v10_11 *result,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,flags,result,resultDisplayMode);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_GetDisplayModeIterator(IDeckLinkInput_v10_11* This,IDeckLinkDisplayModeIterator **iterator) {
    return This->lpVtbl->GetDisplayModeIterator(This,iterator);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_SetScreenPreviewCallback(IDeckLinkInput_v10_11* This,IDeckLinkScreenPreviewCallback *previewCallback) {
    return This->lpVtbl->SetScreenPreviewCallback(This,previewCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_EnableVideoInput(IDeckLinkInput_v10_11* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoInputFlags flags) {
    return This->lpVtbl->EnableVideoInput(This,displayMode,pixelFormat,flags);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_DisableVideoInput(IDeckLinkInput_v10_11* This) {
    return This->lpVtbl->DisableVideoInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_GetAvailableVideoFrameCount(IDeckLinkInput_v10_11* This,unsigned int *availableFrameCount) {
    return This->lpVtbl->GetAvailableVideoFrameCount(This,availableFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_SetVideoInputFrameMemoryAllocator(IDeckLinkInput_v10_11* This,IDeckLinkMemoryAllocator *theAllocator) {
    return This->lpVtbl->SetVideoInputFrameMemoryAllocator(This,theAllocator);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_EnableAudioInput(IDeckLinkInput_v10_11* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_DisableAudioInput(IDeckLinkInput_v10_11* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_GetAvailableAudioSampleFrameCount(IDeckLinkInput_v10_11* This,unsigned int *availableSampleFrameCount) {
    return This->lpVtbl->GetAvailableAudioSampleFrameCount(This,availableSampleFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_StartStreams(IDeckLinkInput_v10_11* This) {
    return This->lpVtbl->StartStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_StopStreams(IDeckLinkInput_v10_11* This) {
    return This->lpVtbl->StopStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_PauseStreams(IDeckLinkInput_v10_11* This) {
    return This->lpVtbl->PauseStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_FlushStreams(IDeckLinkInput_v10_11* This) {
    return This->lpVtbl->FlushStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_SetCallback(IDeckLinkInput_v10_11* This,IDeckLinkInputCallback_v11_5_1 *theCallback) {
    return This->lpVtbl->SetCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v10_11_GetHardwareReferenceClock(IDeckLinkInput_v10_11* This,BMDTimeScale desiredTimeScale,BMDTimeValue *hardwareTime,BMDTimeValue *timeInFrame,BMDTimeValue *ticksPerFrame) {
    return This->lpVtbl->GetHardwareReferenceClock(This,desiredTimeScale,hardwareTime,timeInFrame,ticksPerFrame);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_QueryInterface(IDeckLinkEncoderInput_v10_11* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderInput_v10_11_AddRef(IDeckLinkEncoderInput_v10_11* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderInput_v10_11_Release(IDeckLinkEncoderInput_v10_11* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderInput_v10_11 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_DoesSupportVideoMode(IDeckLinkEncoderInput_v10_11* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoInputFlags flags,BMDDisplayModeSupport_v10_11 *result,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,flags,result,resultDisplayMode);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_GetDisplayModeIterator(IDeckLinkEncoderInput_v10_11* This,IDeckLinkDisplayModeIterator **iterator) {
    return This->lpVtbl->GetDisplayModeIterator(This,iterator);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_EnableVideoInput(IDeckLinkEncoderInput_v10_11* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoInputFlags flags) {
    return This->lpVtbl->EnableVideoInput(This,displayMode,pixelFormat,flags);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_DisableVideoInput(IDeckLinkEncoderInput_v10_11* This) {
    return This->lpVtbl->DisableVideoInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_GetAvailablePacketsCount(IDeckLinkEncoderInput_v10_11* This,unsigned int *availablePacketsCount) {
    return This->lpVtbl->GetAvailablePacketsCount(This,availablePacketsCount);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_SetMemoryAllocator(IDeckLinkEncoderInput_v10_11* This,IDeckLinkMemoryAllocator *theAllocator) {
    return This->lpVtbl->SetMemoryAllocator(This,theAllocator);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_EnableAudioInput(IDeckLinkEncoderInput_v10_11* This,BMDAudioFormat audioFormat,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,audioFormat,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_DisableAudioInput(IDeckLinkEncoderInput_v10_11* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_GetAvailableAudioSampleFrameCount(IDeckLinkEncoderInput_v10_11* This,unsigned int *availableSampleFrameCount) {
    return This->lpVtbl->GetAvailableAudioSampleFrameCount(This,availableSampleFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_StartStreams(IDeckLinkEncoderInput_v10_11* This) {
    return This->lpVtbl->StartStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_StopStreams(IDeckLinkEncoderInput_v10_11* This) {
    return This->lpVtbl->StopStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_PauseStreams(IDeckLinkEncoderInput_v10_11* This) {
    return This->lpVtbl->PauseStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_FlushStreams(IDeckLinkEncoderInput_v10_11* This) {
    return This->lpVtbl->FlushStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_SetCallback(IDeckLinkEncoderInput_v10_11* This,IDeckLinkEncoderInputCallback *theCallback) {
    return This->lpVtbl->SetCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderInput_v10_11_GetHardwareReferenceClock(IDeckLinkEncoderInput_v10_11* This,BMDTimeScale desiredTimeScale,BMDTimeValue *hardwareTime,BMDTimeValue *timeInFrame,BMDTimeValue *ticksPerFrame) {
    return This->lpVtbl->GetHardwareReferenceClock(This,desiredTimeScale,hardwareTime,timeInFrame,ticksPerFrame);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkNotification_v10_11_QueryInterface(IDeckLinkNotification_v10_11* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkNotification_v10_11_AddRef(IDeckLinkNotification_v10_11* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkNotification_v10_11_Release(IDeckLinkNotification_v10_11* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkNotification_v10_11 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkNotification_v10_11_Subscribe(IDeckLinkNotification_v10_11* This,BMDNotifications topic,IDeckLinkNotificationCallback *theCallback) {
    return This->lpVtbl->Subscribe(This,topic,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkNotification_v10_11_Unsubscribe(IDeckLinkNotification_v10_11* This,BMDNotifications topic,IDeckLinkNotificationCallback *theCallback) {
    return This->lpVtbl->Unsubscribe(This,topic,theCallback);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_QueryInterface(IDeckLinkConfiguration_v10_9* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkConfiguration_v10_9_AddRef(IDeckLinkConfiguration_v10_9* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkConfiguration_v10_9_Release(IDeckLinkConfiguration_v10_9* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkConfiguration_v10_9 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_SetFlag(IDeckLinkConfiguration_v10_9* This,BMDDeckLinkConfigurationID cfgID,BOOL value) {
    return This->lpVtbl->SetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_GetFlag(IDeckLinkConfiguration_v10_9* This,BMDDeckLinkConfigurationID cfgID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_SetInt(IDeckLinkConfiguration_v10_9* This,BMDDeckLinkConfigurationID cfgID,LONGLONG value) {
    return This->lpVtbl->SetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_GetInt(IDeckLinkConfiguration_v10_9* This,BMDDeckLinkConfigurationID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_SetFloat(IDeckLinkConfiguration_v10_9* This,BMDDeckLinkConfigurationID cfgID,double value) {
    return This->lpVtbl->SetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_GetFloat(IDeckLinkConfiguration_v10_9* This,BMDDeckLinkConfigurationID cfgID,double *value) {
    return This->lpVtbl->GetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_SetString(IDeckLinkConfiguration_v10_9* This,BMDDeckLinkConfigurationID cfgID,BSTR value) {
    return This->lpVtbl->SetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_GetString(IDeckLinkConfiguration_v10_9* This,BMDDeckLinkConfigurationID cfgID,BSTR *value) {
    return This->lpVtbl->GetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_9_WriteConfigurationToPreferences(IDeckLinkConfiguration_v10_9* This) {
    return This->lpVtbl->WriteConfigurationToPreferences(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_QueryInterface(IDeckLinkConfiguration_v10_4* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkConfiguration_v10_4_AddRef(IDeckLinkConfiguration_v10_4* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkConfiguration_v10_4_Release(IDeckLinkConfiguration_v10_4* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkConfiguration_v10_4 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_SetFlag(IDeckLinkConfiguration_v10_4* This,BMDDeckLinkConfigurationID cfgID,BOOL value) {
    return This->lpVtbl->SetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_GetFlag(IDeckLinkConfiguration_v10_4* This,BMDDeckLinkConfigurationID cfgID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_SetInt(IDeckLinkConfiguration_v10_4* This,BMDDeckLinkConfigurationID cfgID,LONGLONG value) {
    return This->lpVtbl->SetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_GetInt(IDeckLinkConfiguration_v10_4* This,BMDDeckLinkConfigurationID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_SetFloat(IDeckLinkConfiguration_v10_4* This,BMDDeckLinkConfigurationID cfgID,double value) {
    return This->lpVtbl->SetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_GetFloat(IDeckLinkConfiguration_v10_4* This,BMDDeckLinkConfigurationID cfgID,double *value) {
    return This->lpVtbl->GetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_SetString(IDeckLinkConfiguration_v10_4* This,BMDDeckLinkConfigurationID cfgID,BSTR value) {
    return This->lpVtbl->SetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_GetString(IDeckLinkConfiguration_v10_4* This,BMDDeckLinkConfigurationID cfgID,BSTR *value) {
    return This->lpVtbl->GetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_4_WriteConfigurationToPreferences(IDeckLinkConfiguration_v10_4* This) {
    return This->lpVtbl->WriteConfigurationToPreferences(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_QueryInterface(IDeckLinkConfiguration_v10_2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkConfiguration_v10_2_AddRef(IDeckLinkConfiguration_v10_2* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkConfiguration_v10_2_Release(IDeckLinkConfiguration_v10_2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkConfiguration_v10_2 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_SetFlag(IDeckLinkConfiguration_v10_2* This,BMDDeckLinkConfigurationID cfgID,BOOL value) {
    return This->lpVtbl->SetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_GetFlag(IDeckLinkConfiguration_v10_2* This,BMDDeckLinkConfigurationID cfgID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_SetInt(IDeckLinkConfiguration_v10_2* This,BMDDeckLinkConfigurationID cfgID,LONGLONG value) {
    return This->lpVtbl->SetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_GetInt(IDeckLinkConfiguration_v10_2* This,BMDDeckLinkConfigurationID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_SetFloat(IDeckLinkConfiguration_v10_2* This,BMDDeckLinkConfigurationID cfgID,double value) {
    return This->lpVtbl->SetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_GetFloat(IDeckLinkConfiguration_v10_2* This,BMDDeckLinkConfigurationID cfgID,double *value) {
    return This->lpVtbl->GetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_SetString(IDeckLinkConfiguration_v10_2* This,BMDDeckLinkConfigurationID cfgID,BSTR value) {
    return This->lpVtbl->SetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_GetString(IDeckLinkConfiguration_v10_2* This,BMDDeckLinkConfigurationID cfgID,BSTR *value) {
    return This->lpVtbl->GetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v10_2_WriteConfigurationToPreferences(IDeckLinkConfiguration_v10_2* This) {
    return This->lpVtbl->WriteConfigurationToPreferences(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_v11_5_QueryInterface(IDeckLinkVideoFrameMetadataExtensions_v11_5* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkVideoFrameMetadataExtensions_v11_5_AddRef(IDeckLinkVideoFrameMetadataExtensions_v11_5* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkVideoFrameMetadataExtensions_v11_5_Release(IDeckLinkVideoFrameMetadataExtensions_v11_5* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkVideoFrameMetadataExtensions_v11_5 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_v11_5_GetInt(IDeckLinkVideoFrameMetadataExtensions_v11_5* This,BMDDeckLinkFrameMetadataID_v11_5 metadataID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,metadataID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_v11_5_GetFloat(IDeckLinkVideoFrameMetadataExtensions_v11_5* This,BMDDeckLinkFrameMetadataID_v11_5 metadataID,double *value) {
    return This->lpVtbl->GetFloat(This,metadataID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_v11_5_GetFlag(IDeckLinkVideoFrameMetadataExtensions_v11_5* This,BMDDeckLinkFrameMetadataID_v11_5 metadataID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,metadataID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkVideoFrameMetadataExtensions_v11_5_GetString(IDeckLinkVideoFrameMetadataExtensions_v11_5* This,BMDDeckLinkFrameMetadataID_v11_5 metadataID,BSTR *value) {
    return This->lpVtbl->GetString(This,metadataID,value);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_QueryInterface(IDeckLinkOutput_v11_4* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkOutput_v11_4_AddRef(IDeckLinkOutput_v11_4* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkOutput_v11_4_Release(IDeckLinkOutput_v11_4* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkOutput_v11_4 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_DoesSupportVideoMode(IDeckLinkOutput_v11_4* This,BMDVideoConnection connection,BMDDisplayMode requestedMode,BMDPixelFormat requestedPixelFormat,BMDSupportedVideoModeFlags flags,BMDDisplayMode *actualMode,BOOL *supported) {
    return This->lpVtbl->DoesSupportVideoMode(This,connection,requestedMode,requestedPixelFormat,flags,actualMode,supported);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_GetDisplayMode(IDeckLinkOutput_v11_4* This,BMDDisplayMode displayMode,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->GetDisplayMode(This,displayMode,resultDisplayMode);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_GetDisplayModeIterator(IDeckLinkOutput_v11_4* This,IDeckLinkDisplayModeIterator **iterator) {
    return This->lpVtbl->GetDisplayModeIterator(This,iterator);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_SetScreenPreviewCallback(IDeckLinkOutput_v11_4* This,IDeckLinkScreenPreviewCallback *previewCallback) {
    return This->lpVtbl->SetScreenPreviewCallback(This,previewCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_EnableVideoOutput(IDeckLinkOutput_v11_4* This,BMDDisplayMode displayMode,BMDVideoOutputFlags flags) {
    return This->lpVtbl->EnableVideoOutput(This,displayMode,flags);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_DisableVideoOutput(IDeckLinkOutput_v11_4* This) {
    return This->lpVtbl->DisableVideoOutput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_SetVideoOutputFrameMemoryAllocator(IDeckLinkOutput_v11_4* This,IDeckLinkMemoryAllocator *theAllocator) {
    return This->lpVtbl->SetVideoOutputFrameMemoryAllocator(This,theAllocator);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_CreateVideoFrame(IDeckLinkOutput_v11_4* This,int width,int height,int rowBytes,BMDPixelFormat pixelFormat,BMDFrameFlags flags,IDeckLinkMutableVideoFrame **outFrame) {
    return This->lpVtbl->CreateVideoFrame(This,width,height,rowBytes,pixelFormat,flags,outFrame);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_CreateAncillaryData(IDeckLinkOutput_v11_4* This,BMDPixelFormat pixelFormat,IDeckLinkVideoFrameAncillary **outBuffer) {
    return This->lpVtbl->CreateAncillaryData(This,pixelFormat,outBuffer);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_DisplayVideoFrameSync(IDeckLinkOutput_v11_4* This,IDeckLinkVideoFrame *theFrame) {
    return This->lpVtbl->DisplayVideoFrameSync(This,theFrame);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_ScheduleVideoFrame(IDeckLinkOutput_v11_4* This,IDeckLinkVideoFrame *theFrame,BMDTimeValue displayTime,BMDTimeValue displayDuration,BMDTimeScale timeScale) {
    return This->lpVtbl->ScheduleVideoFrame(This,theFrame,displayTime,displayDuration,timeScale);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_SetScheduledFrameCompletionCallback(IDeckLinkOutput_v11_4* This,IDeckLinkVideoOutputCallback *theCallback) {
    return This->lpVtbl->SetScheduledFrameCompletionCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_GetBufferedVideoFrameCount(IDeckLinkOutput_v11_4* This,unsigned int *bufferedFrameCount) {
    return This->lpVtbl->GetBufferedVideoFrameCount(This,bufferedFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_EnableAudioOutput(IDeckLinkOutput_v11_4* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount,BMDAudioOutputStreamType streamType) {
    return This->lpVtbl->EnableAudioOutput(This,sampleRate,sampleType,channelCount,streamType);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_DisableAudioOutput(IDeckLinkOutput_v11_4* This) {
    return This->lpVtbl->DisableAudioOutput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_WriteAudioSamplesSync(IDeckLinkOutput_v11_4* This,void *buffer,unsigned int sampleFrameCount,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->WriteAudioSamplesSync(This,buffer,sampleFrameCount,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_BeginAudioPreroll(IDeckLinkOutput_v11_4* This) {
    return This->lpVtbl->BeginAudioPreroll(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_EndAudioPreroll(IDeckLinkOutput_v11_4* This) {
    return This->lpVtbl->EndAudioPreroll(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_ScheduleAudioSamples(IDeckLinkOutput_v11_4* This,void *buffer,unsigned int sampleFrameCount,BMDTimeValue streamTime,BMDTimeScale timeScale,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->ScheduleAudioSamples(This,buffer,sampleFrameCount,streamTime,timeScale,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_GetBufferedAudioSampleFrameCount(IDeckLinkOutput_v11_4* This,unsigned int *bufferedSampleFrameCount) {
    return This->lpVtbl->GetBufferedAudioSampleFrameCount(This,bufferedSampleFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_FlushBufferedAudioSamples(IDeckLinkOutput_v11_4* This) {
    return This->lpVtbl->FlushBufferedAudioSamples(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_SetAudioCallback(IDeckLinkOutput_v11_4* This,IDeckLinkAudioOutputCallback *theCallback) {
    return This->lpVtbl->SetAudioCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_StartScheduledPlayback(IDeckLinkOutput_v11_4* This,BMDTimeValue playbackStartTime,BMDTimeScale timeScale,double playbackSpeed) {
    return This->lpVtbl->StartScheduledPlayback(This,playbackStartTime,timeScale,playbackSpeed);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_StopScheduledPlayback(IDeckLinkOutput_v11_4* This,BMDTimeValue stopPlaybackAtTime,BMDTimeValue *actualStopTime,BMDTimeScale timeScale) {
    return This->lpVtbl->StopScheduledPlayback(This,stopPlaybackAtTime,actualStopTime,timeScale);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_IsScheduledPlaybackRunning(IDeckLinkOutput_v11_4* This,BOOL *active) {
    return This->lpVtbl->IsScheduledPlaybackRunning(This,active);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_GetScheduledStreamTime(IDeckLinkOutput_v11_4* This,BMDTimeScale desiredTimeScale,BMDTimeValue *streamTime,double *playbackSpeed) {
    return This->lpVtbl->GetScheduledStreamTime(This,desiredTimeScale,streamTime,playbackSpeed);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_GetReferenceStatus(IDeckLinkOutput_v11_4* This,BMDReferenceStatus *referenceStatus) {
    return This->lpVtbl->GetReferenceStatus(This,referenceStatus);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_GetHardwareReferenceClock(IDeckLinkOutput_v11_4* This,BMDTimeScale desiredTimeScale,BMDTimeValue *hardwareTime,BMDTimeValue *timeInFrame,BMDTimeValue *ticksPerFrame) {
    return This->lpVtbl->GetHardwareReferenceClock(This,desiredTimeScale,hardwareTime,timeInFrame,ticksPerFrame);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v11_4_GetFrameCompletionReferenceTimestamp(IDeckLinkOutput_v11_4* This,IDeckLinkVideoFrame *theFrame,BMDTimeScale desiredTimeScale,BMDTimeValue *frameCompletionTimestamp) {
    return This->lpVtbl->GetFrameCompletionReferenceTimestamp(This,theFrame,desiredTimeScale,frameCompletionTimestamp);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_QueryInterface(IDeckLinkInput_v11_4* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkInput_v11_4_AddRef(IDeckLinkInput_v11_4* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkInput_v11_4_Release(IDeckLinkInput_v11_4* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkInput_v11_4 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_DoesSupportVideoMode(IDeckLinkInput_v11_4* This,BMDVideoConnection connection,BMDDisplayMode requestedMode,BMDPixelFormat requestedPixelFormat,BMDSupportedVideoModeFlags flags,BOOL *supported) {
    return This->lpVtbl->DoesSupportVideoMode(This,connection,requestedMode,requestedPixelFormat,flags,supported);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_GetDisplayMode(IDeckLinkInput_v11_4* This,BMDDisplayMode displayMode,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->GetDisplayMode(This,displayMode,resultDisplayMode);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_GetDisplayModeIterator(IDeckLinkInput_v11_4* This,IDeckLinkDisplayModeIterator **iterator) {
    return This->lpVtbl->GetDisplayModeIterator(This,iterator);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_SetScreenPreviewCallback(IDeckLinkInput_v11_4* This,IDeckLinkScreenPreviewCallback *previewCallback) {
    return This->lpVtbl->SetScreenPreviewCallback(This,previewCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_EnableVideoInput(IDeckLinkInput_v11_4* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoInputFlags flags) {
    return This->lpVtbl->EnableVideoInput(This,displayMode,pixelFormat,flags);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_DisableVideoInput(IDeckLinkInput_v11_4* This) {
    return This->lpVtbl->DisableVideoInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_GetAvailableVideoFrameCount(IDeckLinkInput_v11_4* This,unsigned int *availableFrameCount) {
    return This->lpVtbl->GetAvailableVideoFrameCount(This,availableFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_SetVideoInputFrameMemoryAllocator(IDeckLinkInput_v11_4* This,IDeckLinkMemoryAllocator *theAllocator) {
    return This->lpVtbl->SetVideoInputFrameMemoryAllocator(This,theAllocator);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_EnableAudioInput(IDeckLinkInput_v11_4* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_DisableAudioInput(IDeckLinkInput_v11_4* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_GetAvailableAudioSampleFrameCount(IDeckLinkInput_v11_4* This,unsigned int *availableSampleFrameCount) {
    return This->lpVtbl->GetAvailableAudioSampleFrameCount(This,availableSampleFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_StartStreams(IDeckLinkInput_v11_4* This) {
    return This->lpVtbl->StartStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_StopStreams(IDeckLinkInput_v11_4* This) {
    return This->lpVtbl->StopStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_PauseStreams(IDeckLinkInput_v11_4* This) {
    return This->lpVtbl->PauseStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_FlushStreams(IDeckLinkInput_v11_4* This) {
    return This->lpVtbl->FlushStreams(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_SetCallback(IDeckLinkInput_v11_4* This,IDeckLinkInputCallback_v11_5_1 *theCallback) {
    return This->lpVtbl->SetCallback(This,theCallback);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v11_4_GetHardwareReferenceClock(IDeckLinkInput_v11_4* This,BMDTimeScale desiredTimeScale,BMDTimeValue *hardwareTime,BMDTimeValue *timeInFrame,BMDTimeValue *ticksPerFrame) {
    return This->lpVtbl->GetHardwareReferenceClock(This,desiredTimeScale,hardwareTime,timeInFrame,ticksPerFrame);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_QueryInterface(IDeckLinkEncoderConfiguration_v10_5* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderConfiguration_v10_5_AddRef(IDeckLinkEncoderConfiguration_v10_5* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDeckLinkEncoderConfiguration_v10_5_Release(IDeckLinkEncoderConfiguration_v10_5* This) {
    return This->lpVtbl->Release(This);
}
/*** IDeckLinkEncoderConfiguration_v10_5 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_SetFlag(IDeckLinkEncoderConfiguration_v10_5* This,BMDDeckLinkEncoderConfigurationID cfgID,BOOL value) {
    return This->lpVtbl->SetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_GetFlag(IDeckLinkEncoderConfiguration_v10_5* This,BMDDeckLinkEncoderConfigurationID cfgID,BOOL *value) {
    return This->lpVtbl->GetFlag(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_SetInt(IDeckLinkEncoderConfiguration_v10_5* This,BMDDeckLinkEncoderConfigurationID cfgID,LONGLONG value) {
    return This->lpVtbl->SetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_GetInt(IDeckLinkEncoderConfiguration_v10_5* This,BMDDeckLinkEncoderConfigurationID cfgID,LONGLONG *value) {
    return This->lpVtbl->GetInt(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_SetFloat(IDeckLinkEncoderConfiguration_v10_5* This,BMDDeckLinkEncoderConfigurationID cfgID,double value) {
    return This->lpVtbl->SetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_GetFloat(IDeckLinkEncoderConfiguration_v10_5* This,BMDDeckLinkEncoderConfigurationID cfgID,double *value) {
    return This->lpVtbl->GetFloat(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_SetString(IDeckLinkEncoderConfiguration_v10_5* This,BMDDeckLinkEncoderConfigurationID cfgID,BSTR value) {
    return This->lpVtbl->SetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_GetString(IDeckLinkEncoderConfiguration_v10_5* This,BMDDeckLinkEncoderConfigurationID cfgID,BSTR *value) {
    return This->lpVtbl->GetString(This,cfgID,value);
}
static __WIDL_INLINE HRESULT IDeckLinkEncoderConfiguration_v10_5_GetDecoderConfigurationInfo(IDeckLinkEncoderConfiguration_v10_5* This,void *buffer,LONG bufferSize,LONG *returnedSize) {
...
/*** IDeckLinkOutput_v9_9 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_v9_9_DoesSupportVideoMode(IDeckLinkOutput_v9_9* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoOutputFlags flags,BMDDisplayModeSupport_v10_11 *result,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,flags,result,resultDisplayMode);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v9_9_CreateVideoFrame(IDeckLinkOutput_v9_9* This,int width,int height,int rowBytes,BMDPixelFormat pixelFormat,BMDFrameFlags flags,IDeckLinkMutableVideoFrame **outFrame) {
    return This->lpVtbl->CreateVideoFrame(This,width,height,rowBytes,pixelFormat,flags,outFrame);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v9_9_GetBufferedVideoFrameCount(IDeckLinkOutput_v9_9* This,unsigned int *bufferedFrameCount) {
    return This->lpVtbl->GetBufferedVideoFrameCount(This,bufferedFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v9_9_EnableAudioOutput(IDeckLinkOutput_v9_9* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount,BMDAudioOutputStreamType streamType) {
    return This->lpVtbl->EnableAudioOutput(This,sampleRate,sampleType,channelCount,streamType);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v9_9_DisableAudioOutput(IDeckLinkOutput_v9_9* This) {
    return This->lpVtbl->DisableAudioOutput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v9_9_WriteAudioSamplesSync(IDeckLinkOutput_v9_9* This,void *buffer,unsigned int sampleFrameCount,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->WriteAudioSamplesSync(This,buffer,sampleFrameCount,sampleFramesWritten);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v9_9_ScheduleAudioSamples(IDeckLinkOutput_v9_9* This,void *buffer,unsigned int sampleFrameCount,BMDTimeValue streamTime,BMDTimeScale timeScale,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->ScheduleAudioSamples(This,buffer,sampleFrameCount,streamTime,timeScale,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v9_9_GetBufferedAudioSampleFrameCount(IDeckLinkOutput_v9_9* This,unsigned int *bufferedSampleFrameCount) {
    return This->lpVtbl->GetBufferedAudioSampleFrameCount(This,bufferedSampleFrameCount);
}
...
/*** IDeckLinkInput_v9_2 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v9_2_DoesSupportVideoMode(IDeckLinkInput_v9_2* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDVideoInputFlags flags,BMDDisplayModeSupport_v10_11 *result,IDeckLinkDisplayMode **resultDisplayMode) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,flags,result,resultDisplayMode);
}
...
static __WIDL_INLINE HRESULT IDeckLinkInput_v9_2_GetAvailableVideoFrameCount(IDeckLinkInput_v9_2* This,unsigned int *availableFrameCount) {
    return This->lpVtbl->GetAvailableVideoFrameCount(This,availableFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v9_2_EnableAudioInput(IDeckLinkInput_v9_2* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v9_2_DisableAudioInput(IDeckLinkInput_v9_2* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v9_2_GetAvailableAudioSampleFrameCount(IDeckLinkInput_v9_2* This,unsigned int *availableSampleFrameCount) {
    return This->lpVtbl->GetAvailableAudioSampleFrameCount(This,availableSampleFrameCount);
}
...
static __WIDL_INLINE HRESULT IDeckLinkInput_v9_2_SetCallback(IDeckLinkInput_v9_2* This,IDeckLinkInputCallback_v11_5_1 *theCallback) {
    return This->lpVtbl->SetCallback(This,theCallback);
}
...
static __WIDL_INLINE HRESULT IDeckLinkDeckControlStatusCallback_v8_1_DeckControlStatusChanged(IDeckLinkDeckControlStatusCallback_v8_1* This,BMDDeckControlStatusFlags flags,unsigned int mask) {
    return This->lpVtbl->DeckControlStatusChanged(This,flags,mask);
}
#endif
#endif
...
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v8_1_SendCommand(IDeckLinkDeckControl_v8_1* This,unsigned char *inBuffer,unsigned int inBufferSize,unsigned char *outBuffer,unsigned int *outDataSize,unsigned int outBufferSize,BMDDeckControlError *error) {
    return This->lpVtbl->SendCommand(This,inBuffer,inBufferSize,outBuffer,outDataSize,outBufferSize,error);
}
...
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v8_1_SetPreroll(IDeckLinkDeckControl_v8_1* This,unsigned int prerollSeconds) {
    return This->lpVtbl->SetPreroll(This,prerollSeconds);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v8_1_GetPreroll(IDeckLinkDeckControl_v8_1* This,unsigned int *prerollSeconds) {
    return This->lpVtbl->GetPreroll(This,prerollSeconds);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v8_1_SetExportOffset(IDeckLinkDeckControl_v8_1* This,int exportOffsetFields) {
    return This->lpVtbl->SetExportOffset(This,exportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v8_1_GetExportOffset(IDeckLinkDeckControl_v8_1* This,int *exportOffsetFields) {
    return This->lpVtbl->GetExportOffset(This,exportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v8_1_GetManualExportOffset(IDeckLinkDeckControl_v8_1* This,int *deckManualExportOffsetFields) {
    return This->lpVtbl->GetManualExportOffset(This,deckManualExportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v8_1_SetCaptureOffset(IDeckLinkDeckControl_v8_1* This,int captureOffsetFields) {
    return This->lpVtbl->SetCaptureOffset(This,captureOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v8_1_GetCaptureOffset(IDeckLinkDeckControl_v8_1* This,int *captureOffsetFields) {
    return This->lpVtbl->GetCaptureOffset(This,captureOffsetFields);
}
...
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v7_9_SetPreroll(IDeckLinkDeckControl_v7_9* This,unsigned int prerollSeconds) {
    return This->lpVtbl->SetPreroll(This,prerollSeconds);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v7_9_GetPreroll(IDeckLinkDeckControl_v7_9* This,unsigned int *prerollSeconds) {
    return This->lpVtbl->GetPreroll(This,prerollSeconds);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v7_9_SetExportOffset(IDeckLinkDeckControl_v7_9* This,int exportOffsetFields) {
    return This->lpVtbl->SetExportOffset(This,exportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v7_9_GetExportOffset(IDeckLinkDeckControl_v7_9* This,int *exportOffsetFields) {
    return This->lpVtbl->GetExportOffset(This,exportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v7_9_GetManualExportOffset(IDeckLinkDeckControl_v7_9* This,int *deckManualExportOffsetFields) {
    return This->lpVtbl->GetManualExportOffset(This,deckManualExportOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v7_9_SetCaptureOffset(IDeckLinkDeckControl_v7_9* This,int captureOffsetFields) {
    return This->lpVtbl->SetCaptureOffset(This,captureOffsetFields);
}
static __WIDL_INLINE HRESULT IDeckLinkDeckControl_v7_9_GetCaptureOffset(IDeckLinkDeckControl_v7_9* This,int *captureOffsetFields) {
    return This->lpVtbl->GetCaptureOffset(This,captureOffsetFields);
}
...
/*** IDeckLinkOutput_v7_6 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_6_DoesSupportVideoMode(IDeckLinkOutput_v7_6* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDDisplayModeSupport_v10_11 *result) {
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_6_CreateVideoFrame(IDeckLinkOutput_v7_6* This,int width,int height,int rowBytes,BMDPixelFormat pixelFormat,BMDFrameFlags flags,IDeckLinkMutableVideoFrame_v7_6 **outFrame) {
    return This->lpVtbl->CreateVideoFrame(This,width,height,rowBytes,pixelFormat,flags,outFrame);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_6_GetBufferedVideoFrameCount(IDeckLinkOutput_v7_6* This,unsigned int *bufferedFrameCount) {
    return This->lpVtbl->GetBufferedVideoFrameCount(This,bufferedFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_6_EnableAudioOutput(IDeckLinkOutput_v7_6* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount,BMDAudioOutputStreamType streamType) {
    return This->lpVtbl->EnableAudioOutput(This,sampleRate,sampleType,channelCount,streamType);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_6_DisableAudioOutput(IDeckLinkOutput_v7_6* This) {
    return This->lpVtbl->DisableAudioOutput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_6_WriteAudioSamplesSync(IDeckLinkOutput_v7_6* This,void *buffer,unsigned int sampleFrameCount,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->WriteAudioSamplesSync(This,buffer,sampleFrameCount,sampleFramesWritten);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_6_ScheduleAudioSamples(IDeckLinkOutput_v7_6* This,void *buffer,unsigned int sampleFrameCount,BMDTimeValue streamTime,BMDTimeScale timeScale,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->ScheduleAudioSamples(This,buffer,sampleFrameCount,streamTime,timeScale,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_6_GetBufferedAudioSampleFrameCount(IDeckLinkOutput_v7_6* This,unsigned int *bufferedSampleFrameCount) {
    return This->lpVtbl->GetBufferedAudioSampleFrameCount(This,bufferedSampleFrameCount);
}
...
/*** IDeckLinkInput_v7_6 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_6_DoesSupportVideoMode(IDeckLinkInput_v7_6* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDDisplayModeSupport_v10_11 *result) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,result);
}
...
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_6_GetAvailableVideoFrameCount(IDeckLinkInput_v7_6* This,unsigned int *availableFrameCount) {
    return This->lpVtbl->GetAvailableVideoFrameCount(This,availableFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_6_EnableAudioInput(IDeckLinkInput_v7_6* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_6_DisableAudioInput(IDeckLinkInput_v7_6* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_6_GetAvailableAudioSampleFrameCount(IDeckLinkInput_v7_6* This,unsigned int *availableSampleFrameCount) {
    return This->lpVtbl->GetAvailableAudioSampleFrameCount(This,availableSampleFrameCount);
}
...
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v7_6_Set32PulldownSequenceInitialTimecodeFrame(IDeckLinkConfiguration_v7_6* This,unsigned int aFrameTimecode) {
    return This->lpVtbl->Set32PulldownSequenceInitialTimecodeFrame(This,aFrameTimecode);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v7_6_Get32PulldownSequenceInitialTimecodeFrame(IDeckLinkConfiguration_v7_6* This,unsigned int *aFrameTimecode) {
    return This->lpVtbl->Get32PulldownSequenceInitialTimecodeFrame(This,aFrameTimecode);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v7_6_SetVancSourceLineMapping(IDeckLinkConfiguration_v7_6* This,unsigned int activeLine1VANCsource,unsigned int activeLine2VANCsource,unsigned int activeLine3VANCsource) {
    return This->lpVtbl->SetVancSourceLineMapping(This,activeLine1VANCsource,activeLine2VANCsource,activeLine3VANCsource);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v7_6_GetVancSourceLineMapping(IDeckLinkConfiguration_v7_6* This,unsigned int *activeLine1VANCsource,unsigned int *activeLine2VANCsource,unsigned int *activeLine3VANCsource) {
    return This->lpVtbl->GetVancSourceLineMapping(This,activeLine1VANCsource,activeLine2VANCsource,activeLine3VANCsource);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v7_6_SetAudioInputFormat(IDeckLinkConfiguration_v7_6* This,BMDAudioConnection_v10_2 audioInputFormat) {
    return This->lpVtbl->SetAudioInputFormat(This,audioInputFormat);
}
static __WIDL_INLINE HRESULT IDeckLinkConfiguration_v7_6_GetAudioInputFormat(IDeckLinkConfiguration_v7_6* This,BMDAudioConnection_v10_2 *audioInputFormat) {
...
/*** IDeckLinkOutput_v7_3 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_3_DoesSupportVideoMode(IDeckLinkOutput_v7_3* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDDisplayModeSupport_v10_11 *result) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,result);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_3_CreateVideoFrame(IDeckLinkOutput_v7_3* This,int width,int height,int rowBytes,BMDPixelFormat pixelFormat,BMDFrameFlags flags,IDeckLinkMutableVideoFrame_v7_6 **outFrame) {
    return This->lpVtbl->CreateVideoFrame(This,width,height,rowBytes,pixelFormat,flags,outFrame);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_3_GetBufferedVideoFrameCount(IDeckLinkOutput_v7_3* This,unsigned int *bufferedFrameCount) {
    return This->lpVtbl->GetBufferedVideoFrameCount(This,bufferedFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_3_EnableAudioOutput(IDeckLinkOutput_v7_3* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount,BMDAudioOutputStreamType streamType) {
    return This->lpVtbl->EnableAudioOutput(This,sampleRate,sampleType,channelCount,streamType);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_3_DisableAudioOutput(IDeckLinkOutput_v7_3* This) {
    return This->lpVtbl->DisableAudioOutput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_3_WriteAudioSamplesSync(IDeckLinkOutput_v7_3* This,void *buffer,unsigned int sampleFrameCount,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->WriteAudioSamplesSync(This,buffer,sampleFrameCount,sampleFramesWritten);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_3_ScheduleAudioSamples(IDeckLinkOutput_v7_3* This,void *buffer,unsigned int sampleFrameCount,BMDTimeValue streamTime,BMDTimeScale timeScale,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->ScheduleAudioSamples(This,buffer,sampleFrameCount,streamTime,timeScale,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_3_GetBufferedAudioSampleFrameCount(IDeckLinkOutput_v7_3* This,unsigned int *bufferedSampleFrameCount) {
    return This->lpVtbl->GetBufferedAudioSampleFrameCount(This,bufferedSampleFrameCount);
}
...
/*** IDeckLinkInput_v7_3 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_3_DoesSupportVideoMode(IDeckLinkInput_v7_3* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDDisplayModeSupport_v10_11 *result) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,result);
}
...
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_3_GetAvailableVideoFrameCount(IDeckLinkInput_v7_3* This,unsigned int *availableFrameCount) {
    return This->lpVtbl->GetAvailableVideoFrameCount(This,availableFrameCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_3_EnableAudioInput(IDeckLinkInput_v7_3* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_3_DisableAudioInput(IDeckLinkInput_v7_3* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_3_GetAvailableAudioSampleFrameCount(IDeckLinkInput_v7_3* This,unsigned int *availableSampleFrameCount) {
    return This->lpVtbl->GetAvailableAudioSampleFrameCount(This,availableSampleFrameCount);
}
...
/*** IDeckLinkOutput_v7_1 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_1_DoesSupportVideoMode(IDeckLinkOutput_v7_1* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDDisplayModeSupport_v10_11 *result) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,result);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_1_CreateVideoFrame(IDeckLinkOutput_v7_1* This,int width,int height,int rowBytes,BMDPixelFormat pixelFormat,BMDFrameFlags flags,IDeckLinkVideoFrame_v7_1 **outFrame) {
    return This->lpVtbl->CreateVideoFrame(This,width,height,rowBytes,pixelFormat,flags,outFrame);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_1_CreateVideoFrameFromBuffer(IDeckLinkOutput_v7_1* This,void *buffer,int width,int height,int rowBytes,BMDPixelFormat pixelFormat,BMDFrameFlags flags,IDeckLinkVideoFrame_v7_1 **outFrame) {
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_1_EnableAudioOutput(IDeckLinkOutput_v7_1* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_1_WriteAudioSamplesSync(IDeckLinkOutput_v7_1* This,void *buffer,unsigned int sampleFrameCount,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->WriteAudioSamplesSync(This,buffer,sampleFrameCount,sampleFramesWritten);
}
...
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_1_ScheduleAudioSamples(IDeckLinkOutput_v7_1* This,void *buffer,unsigned int sampleFrameCount,BMDTimeValue streamTime,BMDTimeScale timeScale,unsigned int *sampleFramesWritten) {
    return This->lpVtbl->ScheduleAudioSamples(This,buffer,sampleFrameCount,streamTime,timeScale,sampleFramesWritten);
}
static __WIDL_INLINE HRESULT IDeckLinkOutput_v7_1_GetBufferedAudioSampleFrameCount(IDeckLinkOutput_v7_1* This,unsigned int *bufferedSampleCount) {
...
/*** IDeckLinkInput_v7_1 methods ***/
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_1_DoesSupportVideoMode(IDeckLinkInput_v7_1* This,BMDDisplayMode displayMode,BMDPixelFormat pixelFormat,BMDDisplayModeSupport_v10_11 *result) {
    return This->lpVtbl->DoesSupportVideoMode(This,displayMode,pixelFormat,result);
}
...
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_1_EnableAudioInput(IDeckLinkInput_v7_1* This,BMDAudioSampleRate sampleRate,BMDAudioSampleType sampleType,unsigned int channelCount) {
    return This->lpVtbl->EnableAudioInput(This,sampleRate,sampleType,channelCount);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_1_DisableAudioInput(IDeckLinkInput_v7_1* This) {
    return This->lpVtbl->DisableAudioInput(This);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_1_ReadAudioSamples(IDeckLinkInput_v7_1* This,void *buffer,unsigned int sampleFrameCount,unsigned int *sampleFramesRead,BMDTimeValue *audioPacketTime,BMDTimeScale timeScale) {
    return This->lpVtbl->ReadAudioSamples(This,buffer,sampleFrameCount,sampleFramesRead,audioPacketTime,timeScale);
}
static __WIDL_INLINE HRESULT IDeckLinkInput_v7_1_GetBufferedAudioSampleFrameCount(IDeckLinkInput_v7_1* This,unsigned int *bufferedSampleCount) {
    return This->lpVtbl->GetBufferedAudioSampleFrameCount(This,bufferedSampleCount);
}
